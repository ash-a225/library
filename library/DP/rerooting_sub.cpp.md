...
# :warning: DP/rerooting_sub.cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#e2fca8135c2fadca093abd79a6b1c0d2">DP</a>
* <a href="{{ site.github.repository_url }}/blob/master/DP/rerooting_sub.cpp">View this file on GitHub</a>
...
struct ReRooting {
  private:
    ...
    void dfs2(int v, const T& pre, int p = -1) {
      ...
      for (int i = 0; i < m; ++i) {
        dp_l[i+1] = combine(dp_l[i], f(dp[v][i], G[v][i]));
      }
      for (int i = G[v].size(); i > 0; --i) {
        dp_r[i-1] = combine(dp_r[i], f(dp[v][i-1], G[v][i-1]));
      }
  ...
  public:
    ReRooting(const vector<vector<int> >& G, const F &f, const H &combine, T ne, F g=[](T a, int b){ return a;}):
    G(G),f(f),combine(combine),NE(ne),g(g) {
      n = G.size();
      dp.resize(n);
      ans.assign(n,NE);
    }
